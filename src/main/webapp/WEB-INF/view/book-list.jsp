...
<html>
  ...
  async function deleteBook(id) {
		...
		<div>
			<table border="1" cellspacing="0" cellpadding="5" id="bookTable">
				<thead>
					<tr>
				...
				<tbody>
					<c:forEach var="book" items="${ books }">
						<tr>
							...
							<td>${ book.pub }</td>
							<td>
								<a href="/ssr/book/edit/${ book.id }">編輯</a>
								 | 
								<a href="/ssr/book/delete/${ book.id }" onclick="return confirmDelete();">刪除</a>
								
								&nbsp;|&nbsp;
								<form style="display:inline" method="post" action="/ssr/book/delete/${ book.id }">
									<input type="hidden" name="_method" value="DELETE"/>
									<button type="submit">刪除(method=delete)</button>
								</form>
								&nbsp;|&nbsp;
								<a href="#" onclick="deleteBook(${ book.id })">刪除(fetch)</a>
